### System of linear equations solution using np.linalg.solve() - a.x = b
...
##### ----- main ----- #####
print("\n ~~~ Linear Equations System Resolver  - using np.linalg.solve() - ~~~\n")
...
# Unknowns for the system -  I have CM an r as float
...
print("\n ---> Solution of the System (manual - Cramer's):")
print(guv)
